...
export function AppTopbar() {
  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 shrink-0 items-center justify-between gap-2 px-3 w-full bg-background/80 backdrop-blur-md border-b border-border/50">
