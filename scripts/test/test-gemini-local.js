/**
 * Local Test for Gemini API
 * This tests the Gemini API using your local .env file
 */
...
async function testGeminiStreaming() {
    try {
        ...
        console.error('❌ Error with streaming:', error.message);
        return null;
    }
}

async function testGeminiNonStreaming() {
    try {
        ...
        console.error('❌ Error with non-streaming request:', error.message);
        return null;
    }
}
